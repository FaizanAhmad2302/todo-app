...
async function main() {
  ...
  switch (command) {
    ...
    case "clear": {
      ...
      if (option === "--completed") {
        const confirmed = await askConfirmation("Delete all completed todos?");
      ...
      if (option === "--incomplete") {
        const confirmed = await askConfirmation("Delete all incomplete todos?");
      ...
      if (option === "--all") {
        const confirmed = await askConfirmation("Delete ALL todos?");
      ...
      throw new Error("Clear requires --completed, --incomplete, or --all");
    }
